  ...
  <div class="formNotes">
    ...
    <form @submit="submitNote">
      <div class="menu">
        ...
        <button type="submit" class="bg-sucess btn">Save</button>
      </div>

      <div class="content">
        <input text="text" class="text" placeholder="id" v-model="id">
        <input text="text" class="text" placeholder="Title" v-model="title">
